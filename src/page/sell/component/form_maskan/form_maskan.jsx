...
import {Form, Input, InputNumber, message, Row, Select} from "antd";
...
const translations = {
    Kiril: {
        ...
        orintir: "Ориентир",
        qoshimcha: "Қўшимча",
        heshteg:`#kochmasmulk #realestateuz #toshkentuylar #uytopaman #uyqidiraman #uysotiladi #uyijaraga #arendauy #uybozor #uylaruz #toshkentmulk #uzrealestate #uyagentligi #uyagent #xonalikuy #kvartirasotiladi #ijara #arendatashkent #uytopish #uyqidirish #yunusobod #uyinvestitsiya #kvartiralar #uybozori #uyoldisotdi #premiumuylar #elitauylar #uyremontbilan #tayyoruy #yangiuylar #ijarauchun #arendauz #ijarakvartira #arendatopaman #ijaraxonalar #arendauylar #ijarachilar #ijarabozor`
    },
    Ozbek: {
...
const FormMaskan = ({onGenerate}) => {
    ...
    // ✅ Faqat bu joyda onGenerate chaqiriladi, struktura o‘zgarmaydi
    useEffect(() => {
        if (onGenerate) onGenerate(generatedText);
    }, [generatedText, onGenerate]);
    return (
        <div>
            <Form layout="vertical" form={form} onValuesChange={(_, all) => setFormData(all)}>
                ...
                <Row gutter={12} style={{ gap: "20px" }}>
                    <Form.Item name="Balkon" label={t.balkon.label} style={{width:"100px"}}>
                        <Select>
                    ...
                    <Form.Item name="Dom turi" label={t.domTuri.label} style={{width:"100px"}}>
                        <Select>
                    ...
                    <Form.Item name="Remont" label={t.remont.label} style={{width:"100px"}}>
                        <Select>
